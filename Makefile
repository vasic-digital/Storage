# Storage - Generic, reusable Go module for object storage operations.
...
challenge:
	../challenges/scripts/storage_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Storage - Generic, reusable Go module for object storage operations."
	@echo ""
	@echo "Build & Test:"
